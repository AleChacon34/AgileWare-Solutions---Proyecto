...
function crearBarraNavegacionEmpresarial(){
    ...
    addDivIII.classList.add("logout");
    ...
    addIconIII.classList.add("fa-solid", "fa-right-from-bracket");
    ...
    let linkAnchII = document.createTextNode("Invitaciones");
